...
import julliiua.lab6.common.models.ServerUser;
import julliiua.lab6.common.utility.ExecutionResponse;
import julliiua.lab6.common.utility.User;
import julliiua.lab6.server.managers.PasswordManager;
...
public class UserDatabaseManager {
    ...
    public ExecutionResponse addUser(User user) throws SQLException {
        ...
        return new ExecutionResponse(true, "Пользователь " + user.getName() + " добавлен в базу данных");
    }
    ...
    public ExecutionResponse checkUserPass(String name, String password) {
        try {
            ...
            return new ExecutionResponse(false, "Пользователь не найден");
        }
    }
}
