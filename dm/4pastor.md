...
+ Переход (n − 3 → n):
  $p_3$(n) = $p_3$(n-3) + $p_2$(n-1) = $[\frac{(n-3)^2+3}{12}]$ + $[\frac{n-1}{2}]$= = $[\frac{(n^2-6*n+12)+(6n-6)}{12}]
...
+ $n \mid 2$ пусть n = 2k, тогда $\{\frac{n-1}{2}\}$ = $\frac{1}{2}$ и $\{\frac{(n-3)^2+3}{12}\}$ = $\{\frac{4k^2 - 12k
  + 12}{12}\}$ = $\{\frac{k^2}{3}\}$ <= $\frac{1}{3}$

**Док-ть:** $[\frac{n^2+6}{12}]$ = $[\frac{n^2+3}{12}]$ Нужно доказать, что числа $\frac{n^2+4}{12}$,
$\frac{n^2+5}{12}$, $\frac{n^2+6}{12}$ не целые НО!
